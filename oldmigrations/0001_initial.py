# Generated by Django 5.1.2 on 2025-03-14 21:21
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('habit_image', models.ImageField(blank=True, null=True, upload_to='')),
                ('habit_name', models.CharField(max_length=128)),
                ('habit_description', models.TextField(blank=True, null=True)),
                ('habit_frequency', models.IntegerField(default=1, help_text='Frequency in days (e.g., 1 for daily, 7 for weekly)')),
                ('streak_count', models.IntegerField(default=0, editable=False)),
                ('habit_start_date', models.DateTimeField(default=django.utils.timezone.now, editable=False)),
                ('last_updated', models.DateTimeField(default=django.utils.timezone.now, editable=False)),
                ('habit_completed', models.CharField(choices=[('False', 'Not Completed'), ('True', 'Completed')], default='True', max_length=5)),
                ('accountability_partner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='accountability_habits', to=settings.AUTH_USER_MODEL)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('achievements', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='posts', to='core.achievement')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
